...
$('#cbi-device_discovery-'+cnt+'-device_model').text(_list.model);$('#cbi-device_discovery-'+cnt+'-hostname').text(_list.hostname);$('#cbi-device_discovery-'+cnt+'-mac_address').text(_list.mac);$('#cbi-device_discovery-'+cnt+'-device_ip').text(_list.wan_ip);cnt++;}}}else{$('#row_empty').show();}
