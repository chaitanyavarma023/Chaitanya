...
function root_user(user_name)
	return user_name == "root" or user_name == "admin"
end

-- check if both MSP and Local configurable are enabled
function msp_local_config(msp_disabled, lc_enabled)
	return not(msp_disabled == false and lc_enabled == false)
end
